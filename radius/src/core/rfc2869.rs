...
/// # Errors
///
/// Returns an `AVPError` if `value` is not exactly `16` bytes.
...
/// # Errors
///
/// Returns an `AVPError` if `value` is not exactly `14` bytes.
...
/// # Errors
///
/// Returns an `AVPError` if `value` is not exactly `8` bytes.
